...
class _BuildTeamsDropdownButtonRowState extends State<BuildTeamsDropdownButtonRow> {
  ...
  Widget build(BuildContext context) {
    ...
    if (teamBloc.currentSelectedTeamId == null && widget.teamsSnapshot?.data != null) {
      teamBloc.currentSelectedTeamId = widget.teamsSnapshot?.data?.documents[0]?.documentID;
                  ...
                  child: Flexible(
                    ...
                    child: widget.teamsSnapshot.data.documents.length < 2
                        ...
                        : DropdownButton(
                            ...
                            onChanged: (value) {
                              log(
                                  "In BuildTeamsDropdownButton onChanged - value of _selectedTeamId old: $teamBloc.currentSelectedTeamId");
                              log(
                              ...
                              // });
                              log(
                                  "In BuildTeamsDropdownButton onChanged - value of _selectedTeamId new: $teamBloc.currentSelectedTeamId");
